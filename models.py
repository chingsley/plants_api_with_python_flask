...
# db_user, db_password = get_secrets()
database_path = "postgresql://{}:{}@{}/{}".format(
    'db_user_name_here', 'db_user_password', 'localhost:5432', database_name)

db = SQLAlchemy()


'''
'postgres://kingsleyeneja:chinonxo@localhost:5432/plantsdb' <- db uri
setup_db(app)
